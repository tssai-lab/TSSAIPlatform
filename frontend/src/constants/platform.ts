...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    /** 实验版本管理 */
    EXPERIMENT_VERSIONS: (experimentId: string) => `/api/experiments/${encodeURIComponent(experimentId)}/versions`,
...
export const TASK_STATUS = {
  ...
  QUEUED: { label: '排队中', value: 'queued', color: '#595959' },
  ...
  STOPPED: { label: '已停止', value: 'stopped', color: '#faad14' },
} as const;
